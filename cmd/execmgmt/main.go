...
import (
	...
	"github.com/soominhyunwoo/tools/lib/runsimgh"
	"github.com/soominhyunwoo/tools/lib/runsimslack"
)
...
func main() {
	...
	for index := range seedLists {
		...
		userData.WriteString("cd /home/ec2-user/go/src/github.com/soominhyunwoo/chain-sdk || exit 1\n")
